...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public static final String TAG = ActivityUtil.TAG;
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (DEBUG) {
            Log.e(TAG, "addView: " + child.getClass().getSimpleName());
        }
    ...
    protected final void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        if (DEBUG) {
            Log.e(TAG, String.format("onSizeChanged. W: %d, H: %d", width, height));
        }
        ...
        refreshRefreshableViewSize(width, height);
    ...
    protected final void refreshLoadingViewsSize() {
        ...
        if (DEBUG) {
            Log.e(TAG, String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft, pTop, pRight, pBottom));
        }
    ...
    protected final void setHeaderScroll(int value) {
        if (DEBUG) {
            Log.e(TAG, "setHeaderScroll: " + value);
        }
    ...
    protected final void smoothScrollTo() {
    ...
    protected void updateUIForMode() {
        ...
        if (mMode.showFooterLoadingLayout()) {
            addViewInternal(mFooterLayout, -1, lp);
        }
        refreshLoadingViewsSize();
    ...
    private void addRefreshableView(Context context, T refreshableView) {
        ...
        addViewInternal(mRefreshableViewWrapper, -1, new LayoutParams(LayoutParams.MATCH_PARENT,
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
            ...
            Log.e(TAG, "ptrRefreshableViewBackground");
    ...
    public enum Mode {
        ...
        public static final Mode PULL_DOWN_TO_REFRESH = Mode.PULL_FROM_START;
        public static final Mode PULL_UP_TO_REFRESH = Mode.PULL_FROM_END;
